...
<head>
  ...
  <title>NEO-ZIPPER Management System | Admin - Dashboard</title>
  ...
  <style>
        ...
        @media (min-width:768px){
            #image{
                background-image:url('img/Page_image/login_page/loginimage.jpg');
                height:100vh;
        ...
        <div class="container mt-5">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <h3 class="login-heading text-center mb-4">NEO-ZIPPER Management System</h3>
              <form method="post">
              <?php
              if(isset($error)){
